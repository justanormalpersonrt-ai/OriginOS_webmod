...
const allAnimUnlock = {
  ...
  anim3: {
    box1: "translateX(60px) translateY(-150px) scale(0.3)",
    box2: "translateX(20px) translateY(-150px) scale(0.3)",
    box3: "translateX(-20px) translateY(-150px) scale(0.3)",
    box4: "translateX(-60px) translateY(-150px) scale(0.3)",
    box5: "translateX(-60px) translateY(-100px) scale(0.3)",
    box6: "translateX(-20px) translateY(-100px) scale(0.3)",
    box7: "translateX(20px) translateY(-100px) scale(0.3)",
    box8: "translateX(60px) translateY(-100px) scale(0.3)",
    box9: "translateX(40px) translateY(-60px) scale(0.3)",
    box10: "translateX(40px) translateY(-15px) scale(0.3)",
    box12: "translateX(-40px) translateY(-35px) scale(0.3)",
    box11: "translateX(0px) translateY(150px) scale(0.3)",
  },
  anim4: {
    box1: "scale(1)",
    box2: "scale(1)",
